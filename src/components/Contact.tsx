...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const submissionData = {
      ...formData,
      access_key: '344366ee-e5d5-45ad-b242-983691a0b7db', // Replace with your key
    };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white dark:bg-zinc-900 p-8 rounded-lg shadow-lg">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {submitStatus === 'success' && (<div className="text-green-600 text-center">Message sent successfully! I'll get back to you soon.</div>)}
              {submitStatus === 'error' && (<div className="text-red-600 text-center">Failed to send message. Please try again or contact me directly.</div>)}
            </form>
          </div>
        </div>
      </div>
