  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-[#030712] pt-16 border-b border-transparent dark:border-zinc-800">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-black dark:text-white mb-8">
          FIRDAUS MANALU
        </h1>
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-12 leading-relaxed">
          Undergraduate IT student crafting secure, scalable applications
          with modern technologies. Passionate about building digital
