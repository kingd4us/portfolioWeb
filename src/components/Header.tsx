      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link
              to="/"
              className="p-2 border border-gray-300 dark:border-zinc-700 rounded hover:bg-gray-50 dark:hover:bg-zinc-800"
            >
              <LayoutGrid size={16} />
            </Link>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-200 dark:border-zinc-800">
            <nav className="flex flex-col space-y-4">
              <button
                onClick={() => handleScrollTo("home")}
                className="text-left text-gray-700 dark:text-gray-300 hover:text-black dark:hover:text-white"
              >
                HOME
              </button>
              <button
