...
const Menu = () => {
  ...
  const menuItems = [
    {
      name: "Home",
      icon: <Home size={32} />,
      action: () => handleNavigate("/home", "home"),
    },
    {
      name: "About",
      icon: <User size={32} />,
      action: () => handleNavigate("/home", "about"),
    },
    {
      name: "Skills",
      icon: <Code size={32} />,
      action: () => handleNavigate("/home", "skills"),
    },
    {
      name: "Work",
      icon: <Briefcase size={32} />,
      action: () => handleNavigate("/home", "work"),
    },
    {
      name: "Title",
      nameComponent: (
        <h1 className="text-6xl font-bold text-black dark:text-white">FM</h1>
      ),
    },
    {
      name: "Contact",
      icon: <Mail size={32} />,
      action: () => handleNavigate("/home", "contact"),
    },
    {
      name: "Resume",
      ...
      action: () =>
        window.open(
          "https://drive.google.com/file/d/1TKvBjBmolNRnzLcbOETsvG9WBmMrZJlA/view?usp=sharing",
          "_blank",
          "noopener,noreferrer"
        ),
    },
  ...
  return (
    ...
    >
          ...
          return (
            ...
            >
              {item.action ? (
                <button
                  onClick={item.action}
                  className="flex flex-col items-center justify-center w-full h-full space-y-3 text-base font-medium"
                >
                  {item.icon}
                  <span>{item.name}</span>
                </button>
      ...
      <motion.div
        variants={itemVariants}
        className="absolute bottom-8 right-8 flex space-x-6 text-black dark:text-white"
      >
        <a
          href="github.com/kingd4us"
          target="_blank"
        ...
        <a
          href="linkedin.com/firdaus-manalu"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-gray-600 dark:hover:text-gray-400"
        >
